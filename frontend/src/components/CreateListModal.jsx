        ...
        <div className="flex justify-between items-center px-6 py-4 bg-white/5 border-b border-white/10">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="font-mono text-[10px] text-slate-400 uppercase">Curate custom collection</span>
            </div>
          </div>
          <button 
            onClick={onClose} 
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs text-slate-200">
          <div>
            ...
            <input
              ...
              className="w-full bg-black/40 border border-white/10 rounded-lg px-3.5 py-2.5 text-xs text-slate-100 placeholder:text-slate-500 focus:outline-none focus:border-amber-400/50"
              required
            />
          </div>
